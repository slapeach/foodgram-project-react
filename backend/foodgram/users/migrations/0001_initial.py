    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Это поле должно быть уникальным', max_length=150, unique=True, verbose_name='Логин пользователя')),
                ...
                ('password', models.CharField(help_text='Введите пароль', max_length=150, verbose_name='Пароль от аккаунта')),
                ('role', models.CharField(choices=[('guest', 'guest'), ('user', 'user'), ('admin', 'admin')], default='user', max_length=20, verbose_name='Роль пользователя')),
